...
from .ccf import ClickPixelCognitionFusionModule
...
class HighResolutionNet(nn.Module):
    def __init__(self, width, num_classes, ocr_width=256, small=False,
        ...
        self.fusion_module = ClickPixelCognitionFusionModule(
            inplanes=64, planes=64, norm_layer=norm_layer, relu_inplace=relu_inplace,
        )
    ...
    def compute_hrnet_feats(self, x, additional_features):
        x = self.fusion_module(x, additional_features)
        x = self.layer1(x)
